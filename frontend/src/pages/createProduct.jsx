            ...
            <div className='w-[90%] max-w-[500px] bg-white shadow-md h-auto rounded-md p-6 mx-auto mt-8 sm:mt-16 lg:mt-24'>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className='mt-4'>
                        ...
                        <textarea value={description} className='w-full p-2 border rounded-sm focus:outline-none focus:ring-2 focus:ring-blue-400 hover:shadow-lg transition-shadow duration-200 resize-none' onChange={(e) => setDescription(e.target.value)} placeholder='Provide the product description' rows='3' cols='40'></textarea>
                    </div>
                    <div className='mt-4'>
                        <label className='pb-1 block text-gray-600 font-medium'>
